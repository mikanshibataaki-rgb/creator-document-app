...
export const seedDocument: ProjectDocument = {
  ...
  client: { id: "sample-client", company: "株式会社サンプル商事", person: "山田 太郎", postalCode: "500-8384", address: "岐阜県岐阜市薮田南2-1-1", phone: "058-000-0000", email: "yamada@example.co.jp", invoiceNo: "T1234567890123" },
  vendor: { name: "株式会社東海制作", person: "柴田 晃宏", postalCode: "501-6241", address: "岐阜県羽島市", phone: "058-000-0000", email: "info@tokai-seisaku.example", invoiceNo: "T9876543210987", bankName: "十六銀行", bankBranch: "羽島支店", bankType: "普通", bankAccount: "1234567", bankHolder: "カ）トウカイセイサク" },
  shootDate: "2026-08-05", location: "本社オフィス ／ 岐阜スタジオ", deliveryDate: "2026-09-10", deliverables: "本編動画 1本（横16:9）／ショート動画 1本（縦9:16）／サムネイル 2点", format: "MP4（H.264）, 1920×1080 / 1080×1920", revisions: "2", media: "自社Webサイト・SNS（YouTube / Instagram / X）", usagePeriod: "1年間", secondaryUse: "可（同一媒体内に限る）", snsPermission: "可", websitePermission: "可", portfolioPermission: "要相談",
  confirmationIntro: "本書は、下記案件における業務内容・条件について発注者・受注者双方の認識を確認するものです。", inScope: "撮影2日、編集、テロップ、選曲、カラコレ", outOfScope: "出演者キャスティング、ナレーション収録（別途見積）", notes: "BGMはロイヤリティフリー音源を使用。", credit: "エンドクレジットに「制作：株式会社東海制作」表記", copyright: "著作権は受注者に帰属／使用許諾を発注者へ付与", dataHandover: "完パケのみ。素材・プロジェクトデータの引き渡しは別途。",
  ...
  lines: [
    { id: "line-1", category: "制作人件費", name: "ディレクター", description: "企画〜編集統括", unitPrice: 80000, quantity: 1, unit: "式", tax: "税別" },
    { id: "line-2", category: "制作人件費", name: "カメラマン", description: "撮影2日", unitPrice: 60000, quantity: 2, unit: "日", tax: "税別" },
    { id: "line-3", category: "撮影機材費", name: "カメラ・レンズ一式", description: "FX9 + レンズ", unitPrice: 50000, quantity: 2, unit: "日", tax: "税別" },
    { id: "line-4", category: "照明機材費", name: "照明機材一式", description: "", unitPrice: 30000, quantity: 2, unit: "日", tax: "税別" },
    { id: "line-5", category: "編集費", name: "本編集・カラコレ", description: "本編＋ショート", unitPrice: 150000, quantity: 1, unit: "式", tax: "税別" }
  ],
  expenseLines: [
    { id: "settlement-1", date: "2026-08-05", category: "駐車場代", description: "本社撮影時コインパーキング", payee: "岐阜駅前パーキング", amount: 1800, tax: "税込", hasReceipt: true, paidBy: "柴田", billable: true, memo: "" },
    { id: "settlement-2", date: "2026-08-06", category: "食事代", description: "撮影スタッフ昼食", payee: "弁当店", amount: 6600, tax: "税込", hasReceipt: true, paidBy: "柴田", billable: true, memo: "6名分" }
  ],
